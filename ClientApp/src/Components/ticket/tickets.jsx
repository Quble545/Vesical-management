...
class Tickets extends Component {
  ...
  render() {
    ...
    const filtered = Filter(allTickets, search);
    const sorted = _.orderBy(filtered, [sortColumn.path], [sortColumn.order]);
    const tickets = Paginate(sorted, pageSize, currentPage);
      ...
      <React.Fragment>
        <Card>
          <Card.Header>
            ...
            <p>{filtered.length} tickets are in the database </p>
          </Card.Header>
          <Card.Body>
  ...
  async componentDidMount() {
    ...
    this.setState({ tickets, customers, suppliers, user });
  }
}
